...
colors = repmat(1:length(to_plot), [K^2, 1]);
...
ylabel('G');
zlabel('B');
saveas(figure1, sprintf('expr_compress/paper/img/RGB_components_subspacelowrankapprox%d-%d_%s_3d', args.num_colors, args.terms_per_element, type), 'epsc');
