...
\begin{tabular}{rrr}
\hline
Layer & \multicolumn{2}{c}{Evaluation Time} \\
      & bs=1 & bs=128 \\
\hline
2 & 5 & 5 \\
\hline
\end{tabular}
\label{evaluation_time_alex}
}
\parbox{.45\linewidth}{
\centering
\begin{tabular}{rrr}
...
\caption{Evaluation time per layer on CPU for (left) AlexNet, (right) MattNet. We consider real time application setting (batch size aka bs of 1), and
